...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const title = shippingOption == null ? void 0 : shippingOption.title;
    ...
    const [maxDateString, setMaxDateString] = (0, import_react12.useState)(null);
    ...
    console.log("Shipping option title:", shippingOption == null ? void 0 : shippingOption.title);
    if (selected && shippingOption && shippingOption.title.includes("Express") && maxDateString) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { emphasis: "bold", size: "small", children: `Please be informed the order expects to be shipped by ${maxDateString}.` });
    }
